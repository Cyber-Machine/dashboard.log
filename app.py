...
if uploaded_file is not None :
    ...
    # Taking and converting byte code to string
    lines = list(map(lambda x : x.decode('UTF-8') ,uploaded_file.readlines()))

    # Rest done in else block
    ...
    # col1.write("Total Reboots Since the beginning of System ")
    col2.metric("Device Reboots" , len(Beginning_Now) )
    ...
    Time_byte["Packets Send in KB"] = Rx_Bytes
